// carregat tudo no load da página
...
function updateCart() {
  ...
  cartItems.forEach((item) => {
    ...
    if (course) {
      container.innerHTML += `
        <tr>
          <td><img id="imgCart" src="${course.imagem}" ></td>
          <td>${course.titulo}</td>
          <td>${course.promocao}</td>
          <td>${item.quantity}</td>
          <td><button onclick="removeFromCart(${course.ISBN}); updateCart();">Remove</button></td>
        </tr>
          `;
    }
  });
    ...
    <h1>Detalhes do Curso</h1>
      <div class="product-container">
        ...
        <div class="product-details">
            ...
            <button onclick="event.preventDefault(); addToCart(${
              course.ISBN
      ...
      <div class="swiper-slide">
        <div class="card" id="${course.ISBN}">
          ...
          <div class="info-card">
            ...
            <p class="preco">${soldText}</p><br></br>
            <p>${course.autor}</p>
